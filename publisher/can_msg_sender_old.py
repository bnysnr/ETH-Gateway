...
class can_msg_sender():
    ...
    def send_udp_to_all(self, sock, payload):
        """Sendet Payload in Threads an alle verfügbaren Radar-IPs"""
        # Aktualisiere Radar-IPs dynamisch
    ...
    def start(self):
        ...
        if not self.ip_scanner.wait_for_radars(timeout=5):
            print("⚠️  Fahre ohne Radars fort (werden im Betrieb erkannt)")
        ...
        can_thread.start()
        print("CAN-Sender Thread gestartet")
