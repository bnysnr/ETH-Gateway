...
class GenericSignalStatus(QFrame):
    """Generischer Seitenaufbau inklkusive Tabelle, Elementen und Position für Statuswerte der Radarsensoren"""
    ...
    def __init__(self, parent, gui_font, title, row_labels, columns, geometry_func):
        ...
        label.setGeometry(0, 15, w - 60, 40)
